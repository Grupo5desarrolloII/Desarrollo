<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="areadestino.aspx.cs" Inherits="websilabo.areadestino" %>
...
<head runat="server">
    ...
    <title>Area de Destino | UAC</title>
                      ...
                      <div class="item form-group">
                            ...
                            <div class="col-md-4 col-sm-6 ">
                                <asp:DropDownList class="form-control"  ID="DropDownList1" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" AutoPostBack="True">
                                    ...
                                    <asp:ListItem>Direccion UAC</asp:ListItem>
                                </asp:DropDownList>
