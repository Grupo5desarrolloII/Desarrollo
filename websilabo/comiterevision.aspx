<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comiterevision.aspx.cs" Inherits="websilabo.comiterevision" %>
...
<html lang="es">
  <head runat="server">
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Comité de Revisión | UAC</title>
      ...
      <div class="main_container">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Gestionar Libreria <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="evaluarsilabo.aspx">Agregar Libro</a></li>
                       <li><a href="corregirsilabo.aspx">Corregir Libro</a></li>
                      <%--<li><a href="#">Constancia de Revisión</a></li>
                      <li><a href="#">Enviar Silabos Admitidos</a></li>
        ...
        <div class="right_col" role="main">
          ...
          <div class="tile_count">
            <img src="app/images/acreditada.jpg">
            </div>
          </div>
        </div>            
        <!-- /page content -->
