<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="estudiante.aspx.cs" Inherits="websilabo.estudiante" %>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-sitemap"></i> Inicio <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="#">Registrar Solicitud</a></li>
                ...
                <h3>Registrar Solicitud</h3>
                    ...
                    <div class="row">
                      <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                          <div class="x_title">
                            <h2>Registrar<small>Solicitud</small></h2>
                          ...
                          <div class="x_content">
                            <br />
                              <%--  <div class="item form-group">
                                 <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Asunto <span class="required">*</span></label>
                                    <div class="col-md-4 col-sm-6 ">
                                        <asp:HiddenField ID="HiddenField1" runat="server" />
                                        <div class="col-md-4 col-sm-6 ">
                                            <asp:TextBox class="form-control" ID="txtAsunto" runat="server"></asp:TextBox>
                                        </div>
                      ...
                      <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Asunto <span class="required">*</span>
                            </label>
                            <div class="col-md-4 col-sm-6 ">
                                <asp:TextBox class="form-control" ID="txtAsunto" runat="server"></asp:TextBox>
                            </div>
                      ...
                      <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Codigo Estudiante <span class="required">*</span>
                            </label>
                            <div class="col-md-4 col-sm-6 ">
                                <asp:TextBox class="form-control" ID="txtCodigoRemitente" runat="server"></asp:TextBox>
                            </div>
                      </div>
                      <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Subir Archivo <span class="required">*</span>
                            </label>
                            <div class="col-md-4 col-sm-6 ">
                                <asp:FileUpload ID="FileUpload1" runat="server" /> 
                                <asp:TextBox class="form-control" ID="txtNombreArchivo" runat="server" placeholder="Escriba Nombre de Archivo"></asp:TextBox>
                            </div>
                      </div>
                      <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Fecha Registro <span class="required">*</span>
                            </label>
                            <div class="col-md-4 col-sm-6 ">
                                <asp:TextBox class="form-control" ID="txtFechaRegistro" runat="server" ReadOnly="True"></asp:TextBox>
                            </div>
                      </div>
                      <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Tipo de Solicitud
                            </label>
                            <div class="col-md-4 col-sm-6 ">
                                <asp:DropDownList class="form-control" ID="cboTipoSoli" runat="server">
                                    <asp:ListItem >Apertura de Asignatura</asp:ListItem>
                                    <asp:ListItem >Cambio de Horario</asp:ListItem>
                                    <asp:ListItem >Curso Paralelo</asp:ListItem>
                                    <asp:ListItem >Curso Electivo</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                      </div>
                      <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Area de Destino
                            </label>
                            <div class="col-md-4 col-sm-6 ">
                                <asp:DropDownList class="form-control" ID="cboArea" runat="server">
                                    <asp:ListItem >Direccion EPIS</asp:ListItem>
                       ...
                       <div class="ln_solid"></div>
                            ...
                            <div class="col-md-4 col-sm-6 offset-md-3">
                                ...
                                <asp:Button class="btn btn-danger" ID="btnEliminar" runat="server" Text="Eliminar" OnClick="btnEliminar_Click" Visible="False"  />
                                <asp:Button class="btn btn-primary" ID="btnReset" runat="server" Text="Reset" OnClick="btnReset_Click" Visible="False"  />
