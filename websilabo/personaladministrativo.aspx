<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="personaladministrativo.aspx.cs" Inherits="websilabo.personaladministrativo" %>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Asistencia Administrativa <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="docentesresponsables.aspx">Lista de Docentes Encargados </a></li>
                  ...
                  <li><a><i class="fa fa-windows"></i> Gestionar Usuario <span class="fa fa-chevron-down"></span></a>                    
                  </li>
                  <li><a><i class="fa fa-windows"></i> Administracion <span class="fa fa-chevron-down"></span></a>                    
                  </li>
                  <li><a><i class="fa fa-sitemap"></i> Configuración <span class="fa fa-chevron-down"></span></a>
                  </li>
                </ul>
              </div>
