<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aula.aspx.cs" Inherits="websilabo.aula" %>
...
<head runat="server">
    ...
    <title>Gestion de Aulas | UAC</title>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-sitemap"></i> Inicio <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                       ...
                       <li><a href="#">Gestionar Aula</a></li>
                       <li><a href="semestreacademico.aspx">Gestionar Semestre Academico</a></li>
                ...
                <h3>Aulas</h3>
                    ...
                    <div class="row">
                      ...
                      <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Numero Aula <span class="required">*</span>
                            </label>
                            <div class="col-md-4 col-sm-6 ">
                                <asp:TextBox class="form-control" ID="txtNumeroAula" runat="server"></asp:TextBox>
                            </div>
                      </div>
                      <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Tipo de Aula <span class="required">*</span>
                            </label>
                            <div class="col-md-4 col-sm-6 ">
                                <asp:TextBox class="form-control" ID="txtTipoAula" runat="server"></asp:TextBox>
                            </div>
                      </div>
                            ...
                            <div class="col-md-12">
                                <asp:GridView class="table table-striped" ID="gvUsuarios" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="idAula" HeaderText="idAula" InsertVisible="False" ReadOnly="True" SortExpression="idAula" />
                                        <asp:BoundField DataField="NumeroAula" HeaderText="NumeroAula" SortExpression="TipoUsuario" />
                                        <asp:BoundField DataField="TipoAula" HeaderText="TipoAula" SortExpression="Nombres" />
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkVer" runat="server" CommandArgument='<%# Eval("idAula") %>' OnClick="lnk_OnClick">Seleccionar</asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
