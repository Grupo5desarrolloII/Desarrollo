<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reportes.aspx.cs" Inherits="websilabo.reportes" %>
                    ...
                    <div class="row">
                      ...
                      <div class="item form-group">
                            ...
                            <div class="col-md-4 col-sm-6 ">
                                ...
                                <asp:Button class="btn btn-success" ID="btnImprimir" runat="server" Text="Imprimir / Descargar" OnClick="btnImprimir_Click"/>
                            </div>
                      </div>
