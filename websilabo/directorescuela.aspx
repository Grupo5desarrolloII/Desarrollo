<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="directorescuela.aspx.cs" Inherits="websilabo.directorescuela" %>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Configuración <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="establecerfechaentrega.aspx">Establecer fecha y hora para la entrega</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
