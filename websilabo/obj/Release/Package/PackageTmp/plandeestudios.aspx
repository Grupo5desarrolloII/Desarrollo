<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="plandeestudios.aspx.cs" Inherits="websilabo.plandeestudios" %>
...
<head runat="server">
    ...
    <title>Gestion de Plan de Estudios | UAC</title>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-sitemap"></i> Inicio <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="#">Gestionar Plan de Estudios</a></li>
                ...
                <h3>Plan de Estudios</h3>
                    ...
                    <div class="row">
                      <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                          <div class="x_title">
                            <h2>Agregar o quitar Plan de Estudios <small>registrados</small></h2>
                      ...
                      <div class="item form-group">
                            ...
                            <div class="col-md-4 col-sm-6 ">
                                <asp:TextBox class="form-control" ID="txtEscuelaProfecional" runat="server"></asp:TextBox>
                            </div>
                      </div>
                      ...
                      <div class="item form-group">
                            ...
                            <div class="col-md-4 col-sm-6 ">
                                <asp:TextBox class="form-control" ID="txtPlanEstudios" runat="server"></asp:TextBox>
                            </div>
                      </div>
                            ...
                            <div class="col-md-12">
                                <asp:GridView class="table table-striped" ID="gvUsuarios" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="idPlanestudios" HeaderText="idPlanestudios" InsertVisible="False" ReadOnly="True" SortExpression="idPlanestudios" />
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkVer" runat="server" CommandArgument='<%# Eval("idPlanestudios") %>' OnClick="lnk_OnClick">Seleccionar</asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
