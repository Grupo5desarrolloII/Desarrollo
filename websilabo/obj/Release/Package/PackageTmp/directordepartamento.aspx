<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="directordepartamento.aspx.cs" Inherits="websilabo.directordepartamento" %>
...
<html lang="es">
  <head runat="server">
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Director Departamental | UAC</title>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Gestionar Docentes <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="creardocenteresponsable.aspx">Administrar Docentes</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
