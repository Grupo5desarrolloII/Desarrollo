<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buscarpornumerocreditos.aspx.cs" Inherits="websilabo.buscarpornumerocreditos" %>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Gestionar Asignatura <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="#">Buscar por Creditos</a></li>
                    </ul>               
                  </li>
                </ul>
              </div>         
