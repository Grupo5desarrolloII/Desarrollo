<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="actualizarsilabo.aspx.cs" Inherits="websilabo.actualizarsilabo" %>
...
<html lang="es">
  <head runat="server">
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Actualizar Silabo | UAC</title>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Gestionar Asignatura <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="#">Actualizar Silabo</a></li>
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="row">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Actualizar <small>Silabo</small></h2>
                    ...
                    <br />
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-4 col-sm-4 ">
                          <asp:DropDownList class="form-control" ID="cboFacultad" runat="server" AutoPostBack="True" >
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-4 col-sm-4 ">
                          <asp:DropDownList class="form-control" ID="cboAsigntura" runat="server" AutoPostBack="True" >
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-4 col-sm-4 ">
                          <asp:DropDownList class="form-control" ID="cboEscuelaProfesional" runat="server" AutoPostBack="True">
                            </asp:DropDownList>
                        </div>
                      </div>
                      <!-- fin  -->
                  ...
                  <div class="x_content">
                    <br />
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-4 col-sm-4 ">
                            <asp:DropDownList class="form-control" ID="cboObjetivoEduacional" runat="server" DataSourceID="objetivoEducacionalData" DataTextField="NombreObjetivo" DataValueField="NombreObjetivo" AutoPostBack="True" >
                                <%--<asp:ListItem>--SELECT YOUR DEPARTMENT-- </asp:ListItem>--%>
                            </asp:DropDownList>
                            <asp:DropDownList class="form-control" ID="cboObjetivoEducacional2" runat="server" DataSourceID="objetivoEducacionalData" DataTextField="NombreObjetivo" DataValueField="NombreObjetivo" AutoPostBack="True" ></asp:DropDownList>
                            <asp:DropDownList class="form-control" ID="cboObjetivoEducacional3" runat="server" DataSourceID="objetivoEducacionalData" DataTextField="NombreObjetivo" DataValueField="NombreObjetivo" AutoPostBack="True" ></asp:DropDownList>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-4 col-sm-4 ">
                            <asp:DropDownList class="form-control" ID="cboResultadoEstudent" runat="server" DataSourceID="resultadoEstData" DataTextField="SiglasResultado" DataValueField="SiglasResultado" AutoPostBack="True" ></asp:DropDownList>
                            <asp:DropDownList class="form-control" ID="cboResultadoEstudent2" runat="server" DataSourceID="resultadoEstData" DataTextField="SiglasResultado" DataValueField="SiglasResultado" AutoPostBack="True" ></asp:DropDownList>
                            <asp:DropDownList class="form-control" ID="cboResultadoEstudent3" runat="server" DataSourceID="resultadoEstData" DataTextField="SiglasResultado" DataValueField="SiglasResultado" AutoPostBack="True" ></asp:DropDownList>
                            <asp:DropDownList class="form-control" ID="cboResultadoEstudent4" runat="server" DataSourceID="resultadoEstData" DataTextField="SiglasResultado" DataValueField="SiglasResultado" AutoPostBack="True" ></asp:DropDownList>                           
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-4 col-sm-4 ">
                            <asp:DropDownList class="form-control" ID="cboIndiDesempeno" runat="server" DataSourceID="indicadorDesemData" DataTextField="SiglaIndicador" DataValueField="SiglaIndicador" AutoPostBack="True" ></asp:DropDownList>
                            <asp:DropDownList class="form-control" ID="cboIndiDesempeno2" runat="server" DataSourceID="indicadorDesemData" DataTextField="SiglaIndicador" DataValueField="SiglaIndicador" AutoPostBack="True" ></asp:DropDownList>
                            <asp:DropDownList class="form-control" ID="cboIndiDesempeno3" runat="server" DataSourceID="indicadorDesemData" DataTextField="SiglaIndicador" DataValueField="SiglaIndicador" AutoPostBack="True" ></asp:DropDownList>
                            <asp:DropDownList class="form-control" ID="cboIndiDesempeno4" runat="server" DataSourceID="indicadorDesemData" DataTextField="SiglaIndicador" DataValueField="SiglaIndicador" AutoPostBack="True" ></asp:DropDownList>
