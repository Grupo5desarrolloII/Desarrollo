<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="creardocenteresponsable.aspx.cs" Inherits="websilabo.creardocenteresponsable" %>
...
<head runat="server">
    ...
    <title>Gestion de Docentes | UAC</title>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="directordepartamento.aspx"><i class="fa fa-home"></i> Inicio </a>
                  </li>
                  <li><a><i class="fa fa-edit"></i> Gestionar Docentes <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="#">Administrar Docentes</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
                         ...
                         <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Tipo de Usuario <span class="required">*</span></label>
                            <div class="col-md-4 col-sm-6 ">
                                ...
                                <asp:DropDownList class="form-control" ID="cboTipoUsuario" runat="server">
                                      ...
                                      <asp:ListItem>Director de Escuela</asp:ListItem>
                                      <asp:ListItem>Director Departamental</asp:ListItem>
