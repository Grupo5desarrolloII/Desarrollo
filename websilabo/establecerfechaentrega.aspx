<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="establecerfechaentrega.aspx.cs" Inherits="websilabo.establecerfechaentrega" %>
...
<html lang="es">
  <head runat="server">
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Director Escuela | UAC</title>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Configuración <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="#">Establecer fecha y hora para la entrega</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
                ...
                <h3>Fechas</h3>
                    ...
                    <div class="row">
                      <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                          <div class="x_title">
                            <h2>Establecer Fecha<small></small></h2>
                          ...
                          <div class="x_content">
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-4 col-sm-6 ">
                                        <asp:TextBox class="form-control" ID="txtContra" runat="server" TextMode="Date"></asp:TextBox>
                                    </div>
                                 </div>
                                 <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Fecha Fin <span class="required">*</span>
                                        </label>
                                        <div class="col-md-4 col-sm-6 ">
                                  ...
                                  <div class="item form-group">
                                        ...
                                        <div class="col-md-4 col-sm-6 ">
                                            <asp:Button class="btn btn-danger" ID="Button1" runat="server" Text="Establecer Fecha" OnClick="Button1_Click1" />
                                 </div>
                      </div>
