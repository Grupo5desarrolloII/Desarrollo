<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="semestreacademico.aspx.cs" Inherits="websilabo.semestreacademico" %>
...
<head runat="server">
    ...
    <title>Gestion de Semestres | UAC</title>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-sitemap"></i> Inicio <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="aula.aspx">Gestionar Aula</a></li>
                      <li><a href="#">Gestionar Semestre Academico</a></li>
                ...
                <h3>Semestres Academicos</h3>
                    ...
                    <div class="row">
                      <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                          <div class="x_title">
                            <h2>Agregar o quitar Semestres Academicos <small>registrados</small></h2>
                      ...
                      <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Nombre Semestre Academico <span class="required">*</span>
                            </label>
                            <div class="col-md-4 col-sm-6 ">
                                <asp:TextBox class="form-control" ID="txtNombreSemestre" runat="server"></asp:TextBox>
                            </div>
                      </div>
                      
                      <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Fecha Inicio
                            </label>
                            <div class="col-md-4 col-sm-6 ">
                          ...
                          <div class="item form-group">
                            <div class="col-md-12">
                                <asp:GridView class="table table-striped" ID="gvUsuarios" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal">
                                    <Columns>
                                        <asp:BoundField DataField="idSemestreacademico" HeaderText="idSemestreacademico" InsertVisible="False" ReadOnly="True" SortExpression="idSemestreacademico" />
                                        <asp:BoundField DataField="NombreSemestre" HeaderText="NombreSemestre" SortExpression="NombreSemestre" />
                                        <asp:BoundField DataField="FechaInicio" HeaderText="FechaInicio" SortExpression="FechaInicio" ApplyFormatInEditMode="False" DataFormatString="{0:dd/MM/yyyy}" />
                                        <asp:BoundField DataField="FechaFin" HeaderText="FechaFin" SortExpression="FechaFin" DataFormatString="{0:dd/MM/yyyy}" />
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkVer" runat="server" CommandArgument='<%# Eval("idSemestreacademico") %>' OnClick="lnk_OnClick">Seleccionar</asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
